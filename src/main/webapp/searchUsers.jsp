<%@page import="java.util.List" %>
    ...
    <form action="Controller" method="get" class="mb-5">
        ...
        <div class="row g-2 justify-content-center">
            <div class="col-md-6">
                <input type="email" class="form-control" name="email" placeholder="Introduce un email" required>
            </div>
            <div class="col-md-2">
    ...
    <c:if test="${not empty foundUser}">
        <div class="card text-center mx-auto" style="max-width: 400px;">
            <div class="card-body">
                ...
                <p class="card-text"><strong>Email:</strong> ${foundUser.email}</p>

                <form action="Controller" method="get">
                    <input type="hidden" name="operacion" value="followUser" />
                    <input type="hidden" name="followedId" value="${foundUser.id}" />
